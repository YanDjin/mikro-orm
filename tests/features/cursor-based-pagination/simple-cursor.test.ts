...
describe.each([
  ...
  test("using `first` and `after` (id asc)", async () => {
    ...
    // 1. page
    const cursor1 = await orm.em.findByCursor(
      User,
      {},
      {
        first: 3,
    ...
    // 2. page
    const cursor2 = await orm.em.findByCursor(
      User,
      {},
      {
        first: 3,
    ...
    // 3. page
    const cursor3 = await orm.em.findByCursor(
      User,
      {},
      {
        first: 3,
    ...
    // 4. page
    const cursor4 = await orm.em.findByCursor(
      User,
      {},
      {
        first: 40,
    ...
    // 5. page (last)
    const cursor5 = await orm.em.findByCursor(
      User,
      {},
      {
        first: 40,
    ...
    // 6. page (empty)
    const cursor6 = await orm.em.findByCursor(
      User,
      {},
      {
        first: 1,
  ...
  test("using both `before` and `after` with `em.find` (id desc)", async () => {
    const items1 = await orm.em.find(
      User,
      {},
      {
        before: { id: 5 },
    ...
    const items2 = await orm.em.find(
      User,
      {},
      {
        before: { id: 5 },
    ...
    const items3 = await orm.em.find(
      User,
      {},
      {
        before: { id: 5 },
