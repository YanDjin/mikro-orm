...
const redColorFormatterSpy = jest
  .spyOn(colors, "red")
  .mockImplementation((text) => text);
const greyColorFormatterSpy = jest
  .spyOn(colors, "grey")
  .mockImplementation((text) => text);
const cyanColorFormatterSpy = jest
  .spyOn(colors, "cyan")
  .mockImplementation((text) => text);
const yellowColorFormatterSpy = jest
  .spyOn(colors, "yellow")
  .mockImplementation((text) => text);
