...
import type { DatabaseTable } from "@yandjin-mikro-orm/sqlite";
import { DatabaseSchema, SqliteDriver } from "@yandjin-mikro-orm/sqlite";
...
describe("Migrator (sqlite)", () => {
  ...
  test("generate initial migration", async () => {
    ...
    schemaMock.mockReturnValueOnce([
      { name: "author4" } as DatabaseTable,
      { name: "book4" } as DatabaseTable,
    ]);
